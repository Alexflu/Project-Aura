...
- Open **Controls** or press Ctrl+Space, then use arrow keys to select a wheel action and Enter or Space to activate it. Escape closes the wheel and returns keyboard focus to the previous control.
